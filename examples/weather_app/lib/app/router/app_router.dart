...
import 'package:weather_app/app/router/route_not_found_screen.dart';
...
import 'package:weather_app/features/posts/presentation/post_detail_screen.dart';
import 'package:weather_app/features/posts/presentation/post_not_found_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  // read, not watch: watching would rebuild the whole router — losing
  // the navigation stack — every time the analytics provider is
  // invalidated, exactly the trap the comment above warns about for auth.
