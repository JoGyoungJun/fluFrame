...
| Tests out of the box | 1 widget test | Unit + widget, **100% line coverage** | Unit + widget (template measures ~78%) |
...
- **Very Good CLI's 100% coverage is real and fluFrame's is not.** Their
  ...
  routing and theming, and sits around 78% with a CI floor at 72%. More
