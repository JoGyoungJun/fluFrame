...
`NNN-short-slug.md` with these sections:
...
| # | Spec | Status |
|---|---|---|
| 001 | [Backend-neutral auth scaffold](001-auth-scaffold.md) | APPROVED |
| 002 | [fluframe upgrade](002-upgrade-command.md) | APPROVED |
| 003 | [`fluframe add feature`](003-add-feature-command.md) | APPROVED |
| 004 | [Paginated posts](004-paginated-posts.md) | APPROVED |
| 005 | [Wide-viewport content width](005-wide-viewport-content-width.md) | APPROVED |
