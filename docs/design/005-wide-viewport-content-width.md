...
Issue: [#105](https://github.com/JoGyoungJun/fluFrame/issues/105)
Status: APPROVED
...
demo (#98) shipped: a visitor arrives in a desktop browser and sees a
...
- [ ] `docs/architecture.md` describes the cap in its **Template app
      layers** section — the section that documents `core/widgets/`. (The
      issue's criterion said "app-shell description"; that section does not
      exist in the file.)
