...
> Historical record: written against fluframe v1.0.0 and amended at 1.2.0; current behaviour is defined by the code and CHANGELOG.

- **Status**: Accepted (amended 2026-08-06 — see *Amendment: apply
  safety*)
- **Date**: 2026-08-03
- **Related**: design spec 002; shipped in v1.0.0
...
- Generation metadata (`.fluframe.json`) becomes part of the create
  contract from v1.0.0 onward; older apps supply `--from` manually.
