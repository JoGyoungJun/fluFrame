...
argument-hint: "[milestone title, e.g. v1.5.0]"
---
...
- **Goal**: one sentence a stranger understands (e.g. "v1.4.0: safe to
  announce — fix what a first arrival would hit, then post the link").
